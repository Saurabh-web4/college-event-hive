...
const formSchema = z.object({
  ...
  type: z.enum(["hackathon", "workshop", "techtalk", "networking", "career"]),
...
const EventForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // In a real application, you would submit the event to a backend API here
    // For this example, we'll just navigate back to the events page
    navigate("/events");
  }
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {watchIsVirtual ? "Virtual Event Platform" : "Location"}
              </FormLabel>
              <FormControl>
                <Input 
                  placeholder={watchIsVirtual ? "Zoom, Google Meet, etc." : "Enter physical location"} 
                  {...field} 
                />
              </FormControl>
              <FormMessage />
